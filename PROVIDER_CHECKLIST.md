...
The [provider-azureext](https://github.com/crossplane/provider-azureext) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-azureext](https://github.com/crossplane-contrib/provider-jet-azureext) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-azureext/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-azureext/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-azureext/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-azureext/blob/main/hack/boilerplate.go.txt)
...
The [provider-azureext](https://github.com/crossplane/provider-azureext)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-azureext/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-azureext/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue azureexts (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-azureext/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request AzureExts: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-azureext/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
